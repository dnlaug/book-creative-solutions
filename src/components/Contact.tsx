...
const Contact = () => {
  ...
  return <section id="contact" className="section relative overflow-hidden rounded-none">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 flex items-center gap-2 font-labrador">
                    ...
                    <a href="https://w.app/BookCriativos" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-[#fe206b] hover:underline">
