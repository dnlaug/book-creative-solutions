  ...
  return <section id="cases" className="section bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <AnimatedElement direction="up" className="flex flex-wrap justify-center gap-2 mb-12">
          {categories.map((category, index) => <button key={index} onClick={() => setActiveCategory(category)} className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 font-mairy ${activeCategory === category ? "bg-brand-pink text-white shadow-md" : "bg-white hover:bg-gray-100 text-gray-600"}`}>
              {category}
            </button>)}
        </AnimatedElement>
